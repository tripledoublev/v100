...
This is the autonomous training-loop subsystem inside v100.

## Setup

To set up a new experiment, work with the user to:

1. **Agree on a run tag**: propose a tag based on today's date (e.g. `mar5`). The branch `research/<tag>` must not already exist — this is a fresh run.
...
The experiment runs on a dedicated branch (e.g. `research/mar5` or `research/mar5-gpu0`).
